...
A combination of automated [tests](adding_data_long.qmd#sec-adding_data_long) and other [quality controls](check_dataset_functions.qmd#sec-check_dataset_functions) ensure each dataset has been appropriately merged in and the output data are reliable, accurate, and supported by detailed metadata.  
