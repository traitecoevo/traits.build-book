# Data standard {#sec-database_standard}
...
See [relationships between database variables](database_metadata.qmd#sec-database_metadata) for more details.
...
Our ontology remains a work-in-progress; the current release is published as [traits.build ontology v1.0.0](https://traitecoevo.github.io/traits.build/ontology/release/1.0.0/traits.build.ttl).  