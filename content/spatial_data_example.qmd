# Analysis example: Using AusTraits with spatial data {#sec-spatial_data_example}

This tutorial is based on [this great tutorial](https://labs.ala.org.au/posts/2023-08-28_alternatives-to-box-plots/) by Dax Kellie and Shandiya Balasubramaniam from the ALA team.
...
```{r, eval = F}
# install.packages(c("ggdist", "ggtext"))
