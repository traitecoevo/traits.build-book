...
## Our database structure and workflow
...
* The AusTraits data curator runs a series of **tests** on each data set, detailed in the [adding data vignette](http://traitecoevo.github.io/traits.build/articles/adding_data.html)
