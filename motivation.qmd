...
- [traits.build data standard](database_standard.qmd#sec-database_standard): a relational database structure that fully documents the contextual data essential to interpreting ecological data.
- [traits.build R package](traits_build.qmd#sec-traits_build): a set of functions that enable users to create a harmonised database from disparate datasets.
