...
This vignette explains in depth the protocol for adding a new study to AusTraits. Before starting this, you should read more about
...
As you read through this chapter, keep in mind that there are a series of 7 [tutorials](tutorial_dataset_1.html) to break down the process of building a [metadata.yml file](#metadata_file).
