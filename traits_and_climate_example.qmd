# Combining trait values and climate data
...
The code presented here must be run on your off machine, as the climate data files required are not hosted on the traits.build-book GitHub repository.
...
This example uses the most recent AusTraits release, version `r austraits::get_versions()[[2]][1]`
