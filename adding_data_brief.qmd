...
The chapter [Adding datasets, a lengthy guide](adding_data_long.html) then offers a comprehensive guide to generating the `data.csv` and `metadata.yml` files and error-checking your results. This document is likely overwhelming until you are familiar with the traits.build workflow and metadata format.
