...
as the example database. The [`austraits` package chapter](austraits_package.html) is a more concise
...
The [`austraits` package chapter](austraits_package.html) covers these functions as well.
