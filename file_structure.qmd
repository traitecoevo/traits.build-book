...
This chapter desribes the typical files you may encounter in a `traits.build` compilation. The description is based on the [`austraits.build`](https://github.com/traitecoevo/austraits.build/) compilation. 
...
The  [`austraits.build`](https://github.com/traitecoevo/austraits.build/) compilation contains an extra folder, `R` containning a file `custom_R_code.R`. This file documents any custom functions used in the compilation, called as part of the [`custom_R_code` section](#dataset) of metadata files. 
