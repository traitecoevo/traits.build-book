...
-   You can add multiple data collectors by duplicating the relevant 4 lines of code; see the [adding data chapter](adding_data_long.html) for protocols on who to add as a data collector.
